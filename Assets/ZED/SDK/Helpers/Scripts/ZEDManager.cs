...
#pragma warning restore 414
    ...
    {
        //Debug.Log("ZEDManager_StartCoroutine_InitZED()");
        ...
        if (lastInitStatus == sl.ERROR_CODE.SUCCESS)
        {
            ...
            if (OnZEDReady != null)
            {
                //Debug.Log("ZEDManager_(OnZEDReady != null)_OnZEDReady(before)");
                OnZEDReady();
                //Debug.Log("ZEDManager_(OnZEDReady != null)_OnZEDReady(after)");
            }
    ...
    {
        //Debug.Log("ZEDManager_StartBodyTracking!");
    ...
    {
        //Debug.Log("ZEDManager_StartCoroutine_StartBodyTracking!");
        ...
        if (zedCamera != null)
        {
            ...
            if (err == sl.ERROR_CODE.SUCCESS)
            {
                ...
                //Debug.Log("ZEDManager_bodyTrackingRunning=true");
            }
            else
            {
                Debug.Log("Body Tracking failed to start. (Error: " + err + " )");
                bodyTrackingRunning = false;
                //Debug.Log("ZEDManager_bodyTrackingRunning=false");
            }
    ...
    public void UpdateBodiesTracking()
    {
        ...
        //Debug.Log("ZEDManager_Update()_UpdateBodiesTracking()");
        ...
        if (bodyTrackingImageSyncMode == false)
        {
            //Debug.Log("ZEDManager_Update()_UpdateBodiesTracking()_(bodyTrackingImageSyncMode == false)");
            RetrieveBodyTrackingFrame(); //If true, this is called in the AcquireImages function in the image acquisition thread.
        }
        if (newbodiesframeready)
        {
            //Debug.Log("ZEDManager_Update()_UpdateBodiesTracking()_newbodiesframeready=true");
            lock (zedCamera.grabLock)
            {
                ...
                if (OnBodyTracking != null)
                {
                    ...
                    //Debug.Log("ZEDManager_(OnBodyTracking != null)_OnBodyTracking");
