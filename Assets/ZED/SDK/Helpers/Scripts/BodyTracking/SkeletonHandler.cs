...
public class SkeletonHandler : ScriptableObject
{
   ...
   // HumanBodyBones.LastBone, // Right Heel
    ...
    #region added for bone recording
    ...
    {
        //Debug.Log("SkeletonHandler Create!");
        ...
        //----added for bone recording
        actor = humanoid.GetComponent<Actor>();
        //----added for bone recording
    ...
    public void MoveAnimator(bool smoothingEnabled, float smoothValue)
    {
        ...
        //Debug.Log("Update global animation data by given tracked data! ; Update()");
    }
