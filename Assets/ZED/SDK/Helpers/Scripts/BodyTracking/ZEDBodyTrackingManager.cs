...
public class ZEDBodyTrackingManager : MonoBehaviour
{
    ...
    void Start()
    {
		...
		if (zedManager)
        {
            ...
            //Debug.Log("ZEDBTManager_Start()_delegate OnZEDReady()");
            zedManager.OnBodyTracking += UpdateSkeletonData;
            //Debug.Log("ZEDBTManager_Start()_delegate UpdateSkeletonData()");
        }
    ...
    {
        //Debug.Log("ZEDBTManager_OnZEDReady()");
    ...
    {
        //Debug.Log("ZEDBTManager_UpdateSkeletonData()");
        //Debug.Log("UpdateSkeletonData!");
